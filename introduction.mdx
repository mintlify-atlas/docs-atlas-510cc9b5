...
<Tabs>
  <Tab title="Afiliados">
    ...
    3. **Seguimiento del estado** — visualización en tiempo real del estado de la solicitud a lo largo de su ciclo de vida: `POSTULADO` → `DOCUMENTOS_CARGADOS` → `PENDIENTE_FIRMADO` → `APROBADA`.
...
|---|---|---|
| [Nuxt](https://nuxt.com/) | ^4.4.2 | Framework full-stack basado en Vue 3 |
| [Vue](https://vuejs.org/) | ^3.5.33 | Framework UI progresivo y reactivo |
...
| [Zod](https://zod.dev/) | ^4.3.6 | Validación de esquemas en endpoints de la API |
...
| [jose](https://github.com/panva/jose) | ^6.2.2 | Implementación JWT (firma y verificación) |
