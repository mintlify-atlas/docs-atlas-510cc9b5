...
curl -X GET "https://tu-dominio.com/api/convenios/activo"

# Tipos de crédito disponibles
curl -X GET "https://tu-dominio.com/api/lineas_credito/tipo-creditos"

# Parámetros de líneas de crédito
curl -X GET "https://tu-dominio.com/api/lineas_credito/parametros"

# Catálogo de tipos de documento
curl -X GET "https://tu-dominio.com/api/parametros/tipos-documento"

# Roles disponibles
curl -X GET "https://tu-dominio.com/api/parametros/roles"
```
