...
<ParamField body="solicitante" type="object">
  ...
  <Expandable title="Campos de solicitante">
    ...
    <ParamField body="solicitante.pais_nacimiento" type="string">
    ...
    <ParamField body="solicitante.fecha_expedicion" type="string">
    ...
    <ParamField body="solicitante.profesion" type="string">
