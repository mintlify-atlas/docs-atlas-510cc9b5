...
curl -X GET "https://tu-dominio.com/api/notifications" \
  -H "Cookie: nuxt-session=<token>"

# Solo notificaciones no leídas
curl -X GET "https://tu-dominio.com/api/notifications?unread=true" \
  -H "Cookie: nuxt-session=<token>"

# Con límite personalizado
curl -X GET "https://tu-dominio.com/api/notifications?limit=10" \
  -H "Cookie: nuxt-session=<token>"
```
...
```bash
curl -X GET "https://tu-dominio.com/api/notifications/unread-count" \
  -H "Cookie: nuxt-session=<token>"
```
...
```bash
curl -X PUT "https://tu-dominio.com/api/notifications/b3f1c2d4-89ab-4cde-bf01-23456789abcd/read" \
  -H "Cookie: nuxt-session=<token>"
```
...
```bash
curl -X PUT "https://tu-dominio.com/api/notifications/mark-all-read" \
  -H "Cookie: nuxt-session=<token>"
```
...
```bash
curl -X DELETE "https://tu-dominio.com/api/notifications/b3f1c2d4-89ab-4cde-bf01-23456789abcd" \
  -H "Cookie: nuxt-session=<token>"
```
